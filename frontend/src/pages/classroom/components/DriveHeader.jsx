...
const DriveHeader = ({ path, onNavigate, onUpload, onCreateFolder, uploading }) => {
    ...
    return (
        <div className="flex flex-col gap-4 mb-6">
            <h1 className="text-2xl font-bold text-base-content">Classroom Drive</h1>
            
            {/* Breadcrumbs */}
            <div className="text-sm breadcrumbs bg-base-100 p-2 rounded-lg shadow-sm border border-base-300">
                <ul>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 bg-base-100 p-4 rounded-xl shadow-sm border border-base-300">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <label 
                        htmlFor="fileUpload"
                        className={`btn btn-sm btn-secondary gap-2 ${uploading ? 'btn-disabled opacity-50' : ''} cursor-pointer`}
                    >
                        {uploading ? (
