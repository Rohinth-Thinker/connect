      ...
      <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="flex gap-3 mt-3 overflow-x-auto">
              {images.map((img, i) => (
                <img
                  ...
                  className={` p-1 min-w-20 max-w-20 h-20 object-contain rounded bg-base-200 ${i === activeImageNo && 'border border-[#570DF8]'}`}
        ...
        <div>
          ...
          <input
            ...
            className="input border-none outline-none flex-1"
          />
